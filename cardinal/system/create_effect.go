...
func CreateEffectSystem(world cardinal.WorldContext) error {
	return cardinal.EachMessage[msg.CreateEffectMsg, msg.CreateEffectResult](world, func(request cardinal.TxData[msg.CreateEffectMsg]) (msg.CreateEffectResult, error) {
